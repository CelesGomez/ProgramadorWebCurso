...
-- Tiempo de generación: 18-06-2023 a las 16:21:18
...
--
-- Base de datos: `programador_martes`
--
...
CREATE TABLE IF NOT EXISTS `alumnos` (
  ...
  `celular` varchar(80) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
(0, 'Celeste', 'Gomez', 36, 'celug@hjfdhkfij.com', '123456789');
